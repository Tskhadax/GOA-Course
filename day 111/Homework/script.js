...
const addInList = () => {
    ...
    toDoList.map((item) => {
        ...
        const Remove = () => {
            ...
            // Task 00
            let removeList = toDoList[index]
            // let removeTime = Time[index]

            // Task 01
            toDoList.splice(removeList, 1)
            // Time.splice(removeTime, 1)
            console.log(toDoList)
...
const add = () => {
    ...
    let createMin = createDate.getMinutes()
    let createSec = createDate.getSeconds()


    if (userInputValue.trim() !== '') {
        // let result = createHours + ':' + createMin + ":" + createSec
